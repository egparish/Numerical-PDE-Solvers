...
function [u_gs] = Line_SSOR_Down_Solve(D, p, omega, u_row, prior_u_row, b, num_grid_points)
    % This function is going to be similar to a Thomas algorithm except for
    % solving a system with 2 sub diagonals.  This problem models the down
    ...
    %   Au_gs = b - u_New_(i-1)
    % where A is a diagonal and a sub diagonal so it requires 1 sweep to
    ...
    % REDACTED: the rest of the line SSOR down solve code is available on
    % request
