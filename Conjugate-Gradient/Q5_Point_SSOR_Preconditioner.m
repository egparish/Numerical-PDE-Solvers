...
function [y] = Q5_Point_SSOR_Preconditioner(omega, b, N, p, num_grid_points)
    % This function is going to implement point SSOR to solve for the
    ...
    % From the discretization of 5 we have the following for the rows of A
    ...
    % first sweep to solve (D - omega * L)x = omega * b.  This
    % implementation is going to be modified from the first project
    x_initial = zeros(N, 1);

    % REDACTED: point SSOR preconditioner code is available on request
