...
function [u] = macbf24(u, n, lambda, c)
    % This function is going to complete one step of the 2-4 MacCormack 
    % method using a backwards predictor and a forwards corrector.
    % Inputs:
    %   u = current solution
    ...
    % REDACTED: the 2-4 backwards-forward step is available on request
