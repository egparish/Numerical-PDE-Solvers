...
function [u] = macfb24(u, n, lambda, c)
    % This function is going to complete one step of the 2-4 MacCormack 
    % method using a forwards predictor and a backwards corrector.
    % Inputs:
    %   u = current solution
    ...
    % REDACTED: the 2-4 forwards-backward step is available on request
